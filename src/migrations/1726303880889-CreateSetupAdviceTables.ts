...
export class CreateSetupAdviceTables1726303880889 implements MigrationInterface {
    name = 'CreateSetupAdviceTables1726303880889'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`set_advice\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`slNo\` int NOT NULL, \`created_at\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updated_by\` int NULL, \`updated_at\` datetime NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`rxAdvice\` ADD CONSTRAINT \`FK_48e35eeaf6ead2ea0ace9e14946\` FOREIGN KEY (\`adviceId\`) REFERENCES \`set_advice\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE \`set_advice\``);
