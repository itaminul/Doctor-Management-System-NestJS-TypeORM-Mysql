...
port: 3306,
  ...
  entities: [PatPatientsInformation, Patientsrx, Rxmedicine, Rxexaminations, RxInvestigations, RxAdvice, Rxcomplains, Medicine, Complains, Set_investigations, SetAdvice, SetExamination], 
